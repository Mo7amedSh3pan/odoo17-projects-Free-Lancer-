...
class SFALoyaltyCard(models.Model):
    _name = 'sfa.loyalty.card'
    ...
    program_id = fields.Many2one('sfa.loyalty', ondelete='restrict', default=lambda self: self.env.context.get('active_id', None))
    ...
    def action_coupon_send(self):
        ...
        ctx = dict(
            default_model='sfa.loyalty.card',
